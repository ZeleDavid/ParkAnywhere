...
public class DAO {
	private static List<ParkirnaHisa> seznamParkirnihHis = new ArrayList<ParkirnaHisa>(Arrays.asList(
			...
			, new ParkirnaHisa("Pri kliničnem", "Klikicna ulica 17", 117, 20, 1.2, 46.551372, 15.648532, "Marjan")
			, new ParkirnaHisa("Pod gradom", "Grajska ulica 1", 43, 2, 1.9, 46.560432, 15.648875, "Anja")
			, new ParkirnaHisa("Pri trgovini", "Trgovska ulica 12", 12, 1, 2.0, 46.564577, 15.642266, "Olga")
			, new ParkirnaHisa("Pod Europarkom", "Obdravska cesta 7", 220, 200, 0.1, 46.554353, 15.652094, "Bard")
			, new ParkirnaHisa("Pri Štuku", "Gosposvetska cesta 100", 77, 77, 1.5, 46.561863, 15.626516, "Gašper")
